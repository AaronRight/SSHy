          ...
          var InputHandler = (function () {
            ...
            InputHandler.prototype.addChar = function (char, code) {
              if (char >= " ") {
                ...
                if (
                  this._terminal.buffer.x + chWidth - 1 >=
                  this._terminal.cols
                ) {
                ...
                ] = [this._terminal.curAttr, char, chWidth, char.charCodeAt(0)];
                this._terminal.buffer.x++;
                this._terminal.updateRange(this._terminal.buffer.y);
                if (chWidth === 2) {
                  this._terminal.buffer.lines.get(row)[
        ...
        function (require, module, exports) {
          ...
          var Terminal = (function (_super) {
            ...
            Terminal.prototype.open = function (parent) {
              ...
              this.compositionHelper = new CompositionHelper_1.CompositionHelper(
                this.textarea,
      ...
      14: [
        function (require, module, exports) {
          ...
          (function (LinkHoverEventTypes) {
            ...
            (LinkHoverEventTypes =
              exports.LinkHoverEventTypes || (exports.LinkHoverEventTypes = {}))
          );
        },
        {},
      ],
            ...
            function Viewport(
              ...
              this.scrollBarWidth =
                this.viewportElement.offsetWidth -
                  this.scrollArea.offsetWidth || FALLBACK_SCROLL_BAR_WIDTH;
          ...
          var AltClickHandler = (function () {
            ...
            AltClickHandler.prototype._wrappedRowsCount = function () {
              ...
              for (var i = 0; i < Math.abs(startRow - endRow); i++) {
                var direction =
                  this._verticalDirection() === Direction.Up ? -1 : 1;
            ...
            BaseRenderLayer.prototype.drawChar = function (
              ...
              if (
                ...
                this._drawUncachedChar(
                  ...
                  x,
                  y,
                  bold && terminal.options.enableBold,
                  dim
                );
              }
            };
      ...
      20: [
        function (require, module, exports) {
          ...
          function acquireCharAtlas(
            ...
            var newEntry = {
              bitmap: CharAtlasGenerator_1.generateCharAtlas(
                window,
                canvasFactory,
                charAtlasConfig
              ),
        ...
        function (require, module, exports) {
          ...
          var CursorRenderLayer = (function (_super) {
            ...
            CursorRenderLayer.prototype._render = function (
              ...
              var charData = terminal.buffer.lines.get(cursorY)[
                terminal.buffer.x
              ];
              if (!charData) {
                return;
            ...
            function Renderer(_terminal, theme) {
              ...
              _this._renderLayers = [
                new TextRenderLayer_1.TextRenderLayer(
                  ...
                  _this._terminal.options.allowTransparency
                ),
      ...
      29: [
        function (require, module, exports) {
          ...
          function generateCharAtlas(context, canvasFactory, request) {
            var cellWidth =
              request.scaledCharWidth + exports.CHAR_ATLAS_CELL_SPACING;
            var cellHeight =
              request.scaledCharHeight + exports.CHAR_ATLAS_CELL_SPACING;
          ...
          function getFont(fontWeight, request) {
            return (
              fontWeight +
              " " +
              request.fontSize * request.devicePixelRatio +
              "px " +
              request.fontFamily
            );
          }
        ...
        function (require, module, exports) {
          ...
          function proposeGeometry(term) {
            ...
            var availableWidth =
              parentElementWidth -
              elementPaddingHor -
              term.viewport.scrollBarWidth;
            var geometry = {
              cols: Math.floor(
                availableWidth / term.renderer.dimensions.actualCellWidth
              ),
              rows: Math.floor(
                availableHeight / term.renderer.dimensions.actualCellHeight
              ),
            };
            return geometry;
          }
